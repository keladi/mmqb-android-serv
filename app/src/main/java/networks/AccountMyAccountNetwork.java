...
public class AccountMyAccountNetwork{
    private Context context;
    public AccountMyAccountNetwork(Context context){
...
@JSONField(name = "fanxian")
 public String fanxian;
@JSONField(name = "shoukuan")
 public String shoukuan;
@JSONField(name = "fenrun")
...
//请求
    ...
    public void request(final Params params,final Callback callback){
        ...
        Log.d("NETWORK_URL", NetworkConfig.Server+"/rest/account/my_account");
        Log.d("NETWORK_PARAMS", JSON.toJSONString(params));
        StringRequest stringRequest = new StringRequest(Request.Method.POST, NetworkConfig.Server+"/rest/account/my_account",
