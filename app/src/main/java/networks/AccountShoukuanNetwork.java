...
public class AccountShoukuanNetwork{
    private Context context;
    public AccountShoukuanNetwork(Context context){
...
//请求
    ...
    public void request(final Params params,final Callback callback){
        ...
        Log.d("NETWORK_URL", NetworkConfig.Server+"/rest/account/shoukuan");
        Log.d("NETWORK_PARAMS", JSON.toJSONString(params));
        StringRequest stringRequest = new StringRequest(Request.Method.POST, NetworkConfig.Server+"/rest/account/shoukuan",
