...
public class ProfitUpgradeGetListNetwork{
    private Context context;
    public ProfitUpgradeGetListNetwork(Context context){
        ...
        "list": [
            {
                ...
                "lv_up_order_id": 12, 
                "amount": 10000, 
                "create_time": 1513010924, 
                "profit_upgrade_id": 15
            }
        ], 
        "page": 1, 
        "page_size": 10, 
...
@JSONField(name = "des")
 public String des;
@JSONField(name = "lv_up_order_id")
 public int lvUpOrderId;
@JSONField(name = "amount")
 public int amount;
@JSONField(name = "create_time")
 public int createTime;
@JSONField(name = "profit_upgrade_id")
 public int profitUpgradeId;
}
...
//请求
    ...
    public void request(final Params params,final Callback callback){
        ...
        Log.d("NETWORK_URL", NetworkConfig.Server+"/rest/profit_upgrade/get_list");
        Log.d("NETWORK_PARAMS", JSON.toJSONString(params));
        StringRequest stringRequest = new StringRequest(Request.Method.POST, NetworkConfig.Server+"/rest/profit_upgrade/get_list",
