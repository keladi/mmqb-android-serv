...
public class TixianLogIndexNetwork{
    private Context context;
    public TixianLogIndexNetwork(Context context){
...
//请求
    ...
    public void request(final Params params,final Callback callback){
        ...
        Log.d("NETWORK_URL", NetworkConfig.Server+"/rest/tixian_log/index");
        Log.d("NETWORK_PARAMS", JSON.toJSONString(params));
        StringRequest stringRequest = new StringRequest(Request.Method.POST, NetworkConfig.Server+"/rest/tixian_log/index",
