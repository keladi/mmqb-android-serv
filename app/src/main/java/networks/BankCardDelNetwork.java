...
public class BankCardDelNetwork{
    private Context context;
    public BankCardDelNetwork(Context context){
...
{
    "acc": "m13809522353", 
    "user_token": "fd59020b31ee645be25959cf3d3e7885", 
    "card_id": 2
}
*/
...
//请求
    ...
    public void request(final Params params,final Callback callback){
        ...
        Log.d("NETWORK_URL", NetworkConfig.Server+"/rest/bank_card/del");
        Log.d("NETWORK_PARAMS", JSON.toJSONString(params));
        StringRequest stringRequest = new StringRequest(Request.Method.POST, NetworkConfig.Server+"/rest/bank_card/del",
