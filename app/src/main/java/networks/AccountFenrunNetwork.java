...
public class AccountFenrunNetwork{
    private Context context;
    public AccountFenrunNetwork(Context context){
...
//请求
    ...
    public void request(final Params params,final Callback callback){
        ...
        Log.d("NETWORK_URL", NetworkConfig.Server+"/rest/account/fenrun");
        Log.d("NETWORK_PARAMS", JSON.toJSONString(params));
        StringRequest stringRequest = new StringRequest(Request.Method.POST, NetworkConfig.Server+"/rest/account/fenrun",
