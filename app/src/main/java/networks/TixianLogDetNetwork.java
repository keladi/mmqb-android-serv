...
public class TixianLogDetNetwork{
    private Context context;
    public TixianLogDetNetwork(Context context){
...
//请求
    ...
    public void request(final Params params,final Callback callback){
        ...
        Log.d("NETWORK_URL", NetworkConfig.Server+"/rest/tixian_log/det");
        Log.d("NETWORK_PARAMS", JSON.toJSONString(params));
        StringRequest stringRequest = new StringRequest(Request.Method.POST, NetworkConfig.Server+"/rest/tixian_log/det",
...
map.put("tixian_log_id",params.tixianLogId+""); 
